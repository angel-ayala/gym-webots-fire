...
from gym_webots_fire.envs import ContinuousUAVEnv
...
class DiscreteUAVEnv(ContinuousUAVEnv):
    ...
    def __init__(self, time_limit=7500,  # 1 min
        ...
        super(DiscreteUAVEnv, self).__init__(
    ...
    def step(self, action):
        ...
        return super(DiscreteUAVEnv, self).step(mapped_action)
